...
const dbCursosList = [
  {
    Id: 1,
    Title: ' Curso de Personalizados de Luxo 2.0',
    urlImage: '/assets/Curso2.0 Capa.jpeg',
    price: '600',
    Description:
      'É um curso 100% PRESENCIAL que vai te guiar passo a passo para você se tornar uma decorador(a) reconhecido(a) e valorizado(a), para VIVER de FESTAS como sempre sonhou, mesmo que ainda não tenha começado.',
  },
  {
    Id: 2,
      ...
      <div
        ...
        <div className="md:flex">
          ...
          <div className="p-8">
            ...
            <a
              href="https://chat.whatsapp.com/I0qG2tUOw5g4lvl1oFwOhO"
